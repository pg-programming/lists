...
def main():
    ...
    # find every instance of ' i ' and '-i-' and uppercase it. make sure you
    # keep track of how many fixes you make and the line numbers of each fix

    # keep track of count, a list of line numbers, and the modified lines

    # iterate over every line in the list of lines (you might find it helpful
    # to start your enumeration at 1)
